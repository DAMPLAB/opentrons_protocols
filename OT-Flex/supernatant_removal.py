...
metadata = {
    ...
    "lastModified": "2026-01-27T19:02:20.527Z",
        ...
        liquid_class=protocol.define_liquid_class(
            ...
            properties={"flex_8channel_1000": {"opentrons/opentrons_flex_96_tiprack_1000ul/1": {
                "aspirate": {
                    ...
                    "delay": {"enabled": True, "duration": 1.2},
                    "mix": {"enabled": False},
                    "submerge": {
                    ...
                    "retract": {
                        ...
                        "delay": {"enabled": True, "duration": 0.3},
                        "end_position": {
                            "offset": {"x": 0, "y": 0, "z": 2},
                            "position_reference": "well-top",
                        },
                ...
                "dispense": {
                    ...
                    "retract": {
                        ...
                        "speed": 200,
                        "touch_tip": {"enabled": False},
                        "blowout": {"enabled": True, "location": "destination", "flow_rate": 900},
                    },
                    "correction_by_volume": [(0, 0)],
